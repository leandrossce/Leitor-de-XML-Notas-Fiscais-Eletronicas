...
def executar():
    ...
    caminhoListaEmpresas=caminho_arquivo  # O ARQUIVO empresas.CSV tem que ficar no mesmo diretório do scritp lendoXMLCompleto4.0.py
                                                                                                        # Nesse arquivo é para constar a origem dos arquivos XML e o destino do relatório que será salvo

    import chardet

    with open(caminhoListaEmpresas, 'rb') as file:
...
def selecionar_diretorio():
    ...
    caminho_diretorio = filedialog.askdirectory(title="Selecione um diretório")
...
btn_arquivo = tk.Button(janela, text="Selecionar arquivo CSV", command=selecionar_arquivo)
...
btn_executar = tk.Button(janela, text="Executar", command=executar)
